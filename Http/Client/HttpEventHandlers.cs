...
namespace PagarmeSDK.Http.Client
{
    /// <summary>
    ...
    public delegate void OnBeforeHttpRequestEventHandler(HTTPClient source, HttpRequest request);
    ...
    public delegate void OnAfterHttpResponseEventHandler(HTTPClient source, HttpResponse response);
}
